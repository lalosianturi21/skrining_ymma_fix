    ...
    btnDiagnosis2.addEventListener('click', function (e) {
        ...
        if (!isUser) {
            ...
            if (!namaUser || !umur || !jenisKelamin || !alamatDomisili || !nikSerumah || !alamatKtp) {
                ...
                if (!namaUser) document.getElementById('nama_user').style.border = '1px solid red';
                if (!umur) document.getElementById('umur').style.border = '1px solid red';
                if (!jenisKelamin) document.getElementById('jenis_kelamin').style.border = '1px solid red';
                if (!alamatKtp) document.getElementById('alamat_ktp').style.border = '1px solid red';
                if (!alamatDomisili) document.getElementById('alamat_domisili').style.border = '1px solid red';
                if (!nikSerumah) document.getElementById('nik_serumah').style.border = '1px solid red';
            } else if (nikSerumah.length !== 16 || isNaN(nikSerumah)) {
                Swal.showValidationMessage('NIK harus terdiri dari 16 digit angka.');
                document.getElementById('nik_serumah').style.border = '1px solid red';
            } else {
                // Reset border jika semua input terisi
                document.getElementById('nama_user').style.border = '1px solid #ced4da';
                document.getElementById('umur').style.border = '1px solid #ced4da';
                document.getElementById('jenis_kelamin').style.border = '1px solid #ced4da';
                document.getElementById('alamat_ktp').style.border = '1px solid #ced4da';
                document.getElementById('alamat_domisili').style.border = '1px solid #ced4da';
                document.getElementById('nik_serumah').style.border = '1px solid #ced4da';
