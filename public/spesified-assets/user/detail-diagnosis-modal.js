...
function drawDetailDiagnosis(response, diagnosed) {
    ...
    if (response.penyakit == null || response.penyakitUnidentified === true) {
        headerDetailDiagnosis.innerText = "Terima kasih sudah mengisi form ini 😊😊";
        subheaderDetailDiagnosis.innerHTML = 'Anda kemungkinan tidak dirujuk';
        ...
        headerDetailDiagnosis.innerText = "Terima kasih sudah mengisi form ini 😊😊";
        subheaderDetailDiagnosis.innerHTML = "Anda kemungkinan " + `<u>${response.penyakit.name}</u>`;
        headerDetailDiagnosis.classList.remove('d-none');
        subheaderDetailDiagnosis.classList.remove('d-none');
