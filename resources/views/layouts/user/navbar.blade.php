<nav class="navbar fixed-top navbar-expand-lg bg-body-transparent" data-aos="fade-down">
    <div class="container">
        ...
        <img src="{{ asset('assets/img/ymma.png') }}" width="200px" height="40px"/>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 font-medium">
                <li class="nav-item">
                    <a class="nav-link beranda" href="#beranda"></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link diagnosis" href="#diagnosis"></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link penyakit" href="#penyakit"></a>
                </li>
            </ul>
